...
export default {
                ...
                <div class="levels">
                    <template v-if="levels.length > 0">
                        ...
                        <div v-if="givenUp || hasCompleted" class="results">
                            ...
                            <Btn v-if="currentPercentage < 1000 && !hasCompleted" @click.native.prevent="showRemaining = true">Show remaining levels</Btn>
                        </div>
                        <!-- Remaining Levels -->
    ...
    methods: {
        ...
        onDone() {
            const nextPercent = this.progression.length + 1;

            this.progression.push(nextPercent); // Assuming 100% completion
            this.save();
        },
        onGiveUp() {
            this.givenUp = true;
